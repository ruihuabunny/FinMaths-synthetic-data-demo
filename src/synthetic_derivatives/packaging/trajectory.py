...
from synthetic_derivatives.packaging.runtime import RuntimeReplayResult
...
def reference_trajectory(result: RuntimeReplayResult) -> tuple[TrajectoryEvent, ...]:
    ...
    return (
        ...
        TrajectoryEvent(
            2,
            "action",
            "Requested the frozen BSM method contract once.",
            tool_name="query_greeks_task_contract_v1",
        ),
        TrajectoryEvent(
            3,
            "tool_result",
            "Received the canonical public method contract.",
            tool_name="query_greeks_task_contract_v1",
        ...
        TrajectoryEvent(
            4,
            "action",
            "Requested all canonically ordered public input rows once.",
            tool_name="query_greeks_task_inputs_v1",
        ),
        TrajectoryEvent(
            5,
            "tool_result",
            "Received and validated the public input row set.",
            tool_name="query_greeks_task_inputs_v1",
        ...
        TrajectoryEvent(
            ...
            tool_name="submit_greeks_submission_v1",
