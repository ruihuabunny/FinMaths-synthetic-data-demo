...
def task_space_config_path(repository_root: Path) -> Path:
    return repository_root / "configs/task_space/derivatives_v1.json"


@pytest.fixture
def mutation_config_path(repository_root: Path) -> Path:
    return repository_root / "configs/mutations/deterministic_v1.json"


@pytest.fixture
def curriculum_config_path(repository_root: Path) -> Path:
    return repository_root / "configs/curricula/adaptive_v1.json"
