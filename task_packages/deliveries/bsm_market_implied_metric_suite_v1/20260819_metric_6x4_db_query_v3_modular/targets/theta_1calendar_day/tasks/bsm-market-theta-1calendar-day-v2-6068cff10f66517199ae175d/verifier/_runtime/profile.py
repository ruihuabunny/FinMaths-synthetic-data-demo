...
_METRIC_SPECS = (
    MetricSpec(
        ...
        submission_schema_version='bsm-market-implied-iv-submission-v2.0.0',
        verifier_id='quantlib-bsm-market-implied-iv-verifier-v2',
        task_id_pattern='^bsm-market-iv-v2-[0-9a-f]{24}$',
    ...
    MetricSpec(
        ...
        verifier_id='quantlib-bsm-market-implied-delta-verifier-v2',
        task_id_pattern='^bsm-market-delta-v2-[0-9a-f]{24}$',
    ...
    MetricSpec(
        ...
        submission_schema_version='bsm-market-implied-gamma-submission-v2.0.0',
        verifier_id='quantlib-bsm-market-implied-gamma-verifier-v2',
        task_id_pattern='^bsm-market-gamma-v2-[0-9a-f]{24}$',
    ...
    MetricSpec(
        ...
        submission_schema_version='bsm-market-implied-vega-1volpt-submission-v2.0.0',
        verifier_id='quantlib-bsm-market-implied-vega-1volpt-verifier-v2',
        task_id_pattern='^bsm-market-vega-1volpt-v2-[0-9a-f]{24}$',
        decimal_constraint='nonnegative_decimal8',
        needs_iv_status=False,
        database_schema_version='bsm-market-metric-task-duckdb-v2.0.0',
        task_version='2.0.0',
    ...
    MetricSpec(
        ...
        submission_schema_version='bsm-market-implied-theta-1calendar-day-submission-v2.0.0',
        verifier_id='quantlib-bsm-market-implied-theta-1calendar-day-verifier-v2',
        task_id_pattern='^bsm-market-theta-1calendar-day-v2-[0-9a-f]{24}$',
        decimal_constraint='signed_decimal8',
        needs_iv_status=False,
        database_schema_version='bsm-market-metric-task-duckdb-v2.0.0',
        task_version='2.0.0',
    ...
    MetricSpec(
        ...
        submission_schema_version='bsm-market-implied-rho-1pct-submission-v2.0.0',
        verifier_id='quantlib-bsm-market-implied-rho-1pct-verifier-v2',
        task_id_pattern='^bsm-market-rho-1pct-v2-[0-9a-f]{24}$',
        decimal_constraint='signed_decimal8',
        needs_iv_status=False,
        database_schema_version='bsm-market-metric-task-duckdb-v2.0.0',
        task_version='2.0.0',
...
DUCKDB_QUERY_V3_PROFILE = RuntimeProfile(
    profile_id='duckdb_query_v3',
    submission_module='submission_duckdb_v3',
    database_schema_version='bsm-market-metric-task-duckdb-v2.0.0',
    task_version='2.0.0',
    metric_specs=_METRIC_SPECS,
)
_RUNTIME_PROFILE = DUCKDB_QUERY_V3_PROFILE
