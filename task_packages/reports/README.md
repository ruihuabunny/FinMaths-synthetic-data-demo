# Packaging reports and handoffs
...
- [`bsm_market_implied_greeks_prompt_v2_rework_handoff.md`](bsm_market_implied_greeks_prompt_v2_rework_handoff.md)
- [`bsm_metric_delivery_unique_db_6x4_rework_plan.md`](bsm_metric_delivery_unique_db_6x4_rework_plan.md)
- [`bsm_public_duckdb_query_v3_migration_plan.md`](bsm_public_duckdb_query_v3_migration_plan.md)
